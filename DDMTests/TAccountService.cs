...
namespace DDMTests
{
    ...
    public class TAccountService
    {
        ...
        public void TestGetUserProfile_WithValidEmail_ReturnsUserProfile()
        {
            ...
            var result = accountService.GetUserProfile(email);
        ...
        public void TestUpdateProfile_WithValidData_UpdatesProfileSuccessfully()
        {
            ...
            var result = accountService.UpdateProfile(email, fullName, phone, address);
        ...
        public void TestUpdateProfile_WithTooLongFullName_ReturnsValidationError()
        {
            ...
            var result = accountService.UpdateProfile(email, longName, "+79991234567", "г. Москва");
        ...
        public void TestChangePassword_WithValidData_ChangesPasswordSuccessfully()
        {
            ...
            var result = accountService.ChangePassword(email, currentPassword, newPassword, repeatPassword);
        ...
        public void TestChangePassword_WithWrongCurrentPassword_ReturnsError()
        {
            ...
            var result = accountService.ChangePassword(email, "WrongPass!", "BetterP4ss!", "BetterP4ss!");
        ...
        public void TestChangePassword_WithWeakNewPassword_ReturnsError()
        {
            ...
            var result = accountService.ChangePassword(email, "OldPassw0rd!", "12345", "12345");
        ...
        public void TestChangePassword_WithMismatchedPasswords_ReturnsError()
        {
            ...
            var result = accountService.ChangePassword(email, "OldPassw0rd!", "BetterP4ss!", "DifferentP4ss!");
